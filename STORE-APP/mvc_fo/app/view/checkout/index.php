			...
			<div class="container">
				<div class="row">
						...
						<div class="shadow bg-white stick-to-content mb-4">
							...
							<table class="table-cart">
								...
								<tr>
									<td class="title">
										<span class="name">
											<a href="#productModal" data-product="<?= $products['pro_id']?>" data-price="<?= $products['pro_price_euro']?>" data-qte="<?= $products['cad_qt']?>" data-sub="<?= $products['pro_subtitle1']?>"data-name="<?= $products['pro_title']?>" data-name="<?= $products['pro_descr']?>" data-toggle="modal">
												<?= $products['cad_qt']?> x <?= $products['pro_title']?>
											</a>
										</span>
									...
									<td class="actions">
									<a href="#productModal" data-product="<?= $products['pro_id']?>" data-price="<?= $products['pro_price_euro']?>" data-qte="<?= $products['cad_qt']?>" data-sub="<?= $products['pro_subtitle1']?>"data-name="<?= $products['pro_title']?>" data-name="<?= $products['pro_descr']?>" data-toggle="modal" class="action-icon">
							...
							<div class="cart-summary">
								...
								<div class="row">
									...
									<div class="col-5"><strong id='livraison'>0</strong><strong>,00€</strong></div>
								</div>
								<hr class="hr-sm">
								<div class="row text-md">
									<div class="col-7 text-right text-muted">Total:</div>
									<div class="col-5"><strong id="total"><?= $total['total'];?></strong><strong>€</strong></div>
								</div>
							</div>
					...
					<div class="col-xl-8 pull-xl-4 col-lg-7 pull-lg-5">	
						<div class="bg-white p-4 p-md-5 mb-4">
							...
							<div class="row text-lg">
								<div class="col-xl-4 col-sm-6 form-group">
									...
									<input type="radio" name="logistic_type" class="custom-control-input" onclick="frais();" value="1" checked>
								...
								<div class="col-xl-4 col-sm-6 form-group">
									<label class="custom-control custom-radio">
									<input type="radio" name="logistic_type" class="custom-control-input" onclick="frais();" value="2">
										<span class="custom-control-indicator"></span>
								...
								<div class="col-xl-4 col-sm-6 form-group">
									<label class="custom-control custom-radio">
									<input type="radio" name="logistic_type" class="custom-control-input" onclick="frais();" value="3">
										<span class="custom-control-indicator"></span>
						...
						<button type="submit" class="btn btn-primary btn-lg"><span>Valider</span></button>
						</div>
					</form>
					</div>
				</div>
