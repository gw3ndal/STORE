...
<div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-v-lg text-center">
        <div class="m-b"><a ui-sref="access.forgot-password" href="<?=root('views/logins/forgotPassword.php')?>" class="text-primary _600">Mot de passe oublié?</a></div>
        <div>Vous n'avez pas de compte?<a ui-sref="access.signup" href="<?=root('views/logins/signup.php')?>" class="text-primary _600"> S'inscrire</a></div>
    </div>
</div>
<!-- ############ LAYOUT END-->
