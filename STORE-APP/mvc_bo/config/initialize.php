...
define("ASSETS_PATH", PROJECT_PATH . '/vendor/assets');
...
// * Can dynamically find everything in URL up to "/vendor"
$vendor_end = strpos($_SERVER['SCRIPT_NAME'], '/vendor') + 7;
$vendor_root = substr($_SERVER['SCRIPT_NAME'], 0, $vendor_end);
define("WWW_VENDOR", $vendor_root);
