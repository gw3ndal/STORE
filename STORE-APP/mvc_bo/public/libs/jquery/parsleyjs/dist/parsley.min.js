...
window.ParsleyConfig.i18n.en = jQuery.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  range:          "Cette valeur doit être comprise entre %s et %s caractères.",
  minlength:      "Cette valeur est trop courte. Il doit avoir %s caractères ou plus.",
  maxlength:      "Cette valeur est trop longue. Il doit avoir %s caractères ou moins.",
  length:         "Cette longueur de valeur n'est pas valide. Il doit comporter entre %s et %s caractères.",
  mincheck:       "Vous devez sélectionner au moins les choix %s.",
  maxcheck:       "Vous devez sélectionner %s choix ou moins.",
  check:          "Vous devez choisir entre %s et %s choix.",
  equalto:        "Cette valeur doit être la même."
});
