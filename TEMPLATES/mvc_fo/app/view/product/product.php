						...
						<div class="product-single">
							...
							<div class="product-content">
								<div class="product-header text-center">
									<h1 class="product-title">CAMEROUN 2017</h1>
									<span class="product-caption text-muted">chocolat noir grand cru | Cameroun</span>
									<span class="product-caption text-muted">Catégories:  Canada, Noir grand cru, Bean to Bar, Bio, équitable, Vegan</span>
									</div>
									<p class="lead">
								...
								<div class="row gutters-sm">
									<div class="col-lg-6 col-12">
										...
										<div class="menu-item menu-grid-item">
											<a href="product_gallery.php"><img class="mb-4" src="https://www.chocolatsdumonde.ch/wp-content/uploads/Millesime_CamerounNoir_A.jpg" alt="tablette"></a>
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<!-- Menu Item -->
										<div class="menu-item menu-grid-item">
											<a href=""><img class="mb-4" src="https://www.chocolatsdumonde.ch/wp-content/uploads/Millesime_CamerounNoir_B.jpg" alt="tablette"></a>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="product-price text-center">8.00€</div>
								<div class="row">
									<div class="col-sm-6">
